...
public interface BookServiceLocal {
     ...
     * @throws LibraryIllegalArgumentException if book is null or does not have set its ID
     */
    void createBook(Book book) throws LibraryIllegalArgumentException;
     ...
     * @throws LibraryIllegalArgumentException if book is null or does not have set its ID
     */
    void updateBook(Book book) throws LibraryIllegalArgumentException;
     ...
     * @throws LibraryIllegalArgumentException if book is null or does not have proper id
     */
    void deleteBook(Book book) throws LibraryIllegalArgumentException;
     ...
     * @throws LibraryIllegalArgumentException if id is null or out of range
     */
    Book getBookByID(Long id) throws LibraryIllegalArgumentException;
     ...
     * @throws LibraryIllegalArgumentException if authorName is null or has zero length
     */
    List<Book> getBooksByAuthor(String authorName) throws LibraryIllegalArgumentException;
     ...
     * @throws LibraryIllegalArgumentException if title is null or has zero length
     */
    List<Book> searchBooksByTitle(String title) throws LibraryIllegalArgumentException;
