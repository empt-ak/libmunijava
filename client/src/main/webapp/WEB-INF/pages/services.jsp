    ...
    <body> 
        ...
        <div id="wrapper">
            ...
            <div id="faux">
                ...
                <a href="<spring:url value="http://localhost:9000/pa165/services/wsdl/BookWebService?wsdl" />">BookWebService</a></br></br>
                <a href="<spring:url value="http://localhost:9000/pa165/services/wsdl/UserWebService?wsdl" />">UserWebService</a></br></br>
