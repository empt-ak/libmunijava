...
public class BookServiceTest extends AbstractJUnit4SpringContextTests {
    ...
    public void init() {
        ...
        listDTOS.add(createBookDTO("pepazdepa", "ach jaj", Department.ADULT, BookStatus.AVAILABLE));
        listDTOS.add(createBookDTO("pepazdepa", "xexe", Department.KIDS, BookStatus.AVAILABLE));
        listDTOS.add(createBookDTO("pepazdepa", "hlavninadrazi", Department.ADULT, BookStatus.AVAILABLE));
    ...
    public void testCreateTicketItem() {
        ...
        doThrow(new IllegalArgumentException("")).when(bookDAO).createBook(null);

        // zavolame metodu
        bookService.createBook(listDTOS.get(2));


        // overime ze bola zavolana
        verify(bookDAO, times(1)).createBook(listDAOS.get(2));
    }
    ...
    public void testGetBooksByAuthor() 
    {
        ...
        tempDTO.add(createBookDTO("stvrtya", "stvrtynazov", Department.ADULT, BookStatus.AVAILABLE));
