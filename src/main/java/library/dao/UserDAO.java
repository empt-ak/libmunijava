...
public interface UserDAO {
    ...
    */ 
    void createUser(UserDO user) throws IllegalArgumentException;
    /**
    ...
    */
    void updateUser(UserDO user) throws IllegalArgumentException;    
    /**
    ...
    */
    void deleteUser(UserDO user) throws IllegalArgumentException;    
    /**
    ...
    */ 
    UserDO getUserByID(Long id) throws IllegalArgumentException;  
    /**
     ...
     */
    UserDO getUserByUsername(String username) throws IllegalArgumentException;
    /**
    ...
    */ 
    List<UserDO> findUserByRealName(String name) throws IllegalArgumentException;
    /**
